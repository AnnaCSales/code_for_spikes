 function medianTrace = applyCARtoDatAndFilter(filename, nChansTotal, outputDir)
...
[b1, a1] = butter(3, [300/ops.fs,6000/ops.fs]*2, 'bandpass');
...
try
  ...
  if nargin < 3
    outputFilename  = [pathstr filesep name '_CARfilter' ext];
    mdTraceFilename = [pathstr filesep name '_medianTrace.mat'];
  else
    outputFilename  = [outputDir filesep name '_CARfilter' ext];
