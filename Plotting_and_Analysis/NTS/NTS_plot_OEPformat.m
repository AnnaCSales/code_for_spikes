...
%% Load in the spikeStruct.
 datapath='D:\NTS_Pabitra\120820\Rec1\CAR\'; %dont forget backslash
 load([datapath 'spikeStruct.mat']);
 
 ADC_fn='D:\NTS_Pabitra\120820\Rec1\CAR\100_ADC2_4.continuous';
...
ADC_tbase=ADC_ts_raw-ADC_ts_raw(1);
