...
ADC_fn='D:\Versus\141020\Rec1\113_ADC3.continuous'
% Path to continuous file with ECG recording.
ECG_fn='D:\Versus\141020\Rec1\113_CH34.continuous';
...
ped_table=pedal_ts
ped_starts_inc=find(ped_table(:,1)>timePlot(1) & ped_table(:,1)<timePlot(2));
